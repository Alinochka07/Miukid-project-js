...
function add_to_card(funct_delete_items_from_cart, calculate_cart, count_items_in_cart) {
  function addToCartFunction(img, ttl, curr, prc) {
    ...
    var block_cart = document.querySelector(".cart_submenu .item .bag_items");
...
;
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (add_to_card);

/***/ }),

/***/ "./script/module/calculate_cart.js":
/*!*****************************************!*\
  !*** ./script/module/calculate_cart.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function calculate_cart() {
  var count_cart = document.querySelectorAll(".item .n_price");
  var count_my_cart = 0;
  for (var i = 0; i < count_cart.length; i++) {
    count_my_cart = count_my_cart + +count_cart[i].textContent;
  }
  document.getElementsByClassName("total_in_my_cart")[0].innerText = "$ ".concat(count_my_cart.toFixed(2));
  document.getElementsByClassName("total_in_this_cart")[0].innerText = "$ ".concat(count_my_cart.toFixed(2));
}
;
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (calculate_cart);

/***/ }),

/***/ "./script/module/count_items_in_cart.js":
/*!**********************************************!*\
  !*** ./script/module/count_items_in_cart.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./script/module/delete_from_cart.js":
/*!*******************************************!*\
  !*** ./script/module/delete_from_cart.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function funct_delete_items_from_cart(calculate_cart, count_items_in_cart) {
  var click_to_trash = document.querySelectorAll(".cart_trash");
...
;
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (funct_delete_items_from_cart);

/***/ }),

/***/ "./script/module/get_product_to_cart.js":
/*!**********************************************!*\
  !*** ./script/module/get_product_to_cart.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function getProductsToCart() {
  var cardProduct = /*#__PURE__*/function () {
    function cardProduct(comment, comment_color, image, title, descr_header, descr_text, n_price, oldprice, innerBlock) {
    ...
    _createClass(cardProduct, [{
      key: "convertToUSD",
      value: function convertToUSD(price) {
        var currency_result = price / this.currency;
      ...
      value: function render() {
        var div_render = document.createElement("div");
        div_render.classList.add("product");
        div_render.innerHTML = "<div class=\"product\">\n                                    <div class=\"image\">\n                                        <img src=".concat(this.image, " alt=\"\" class=\"picture\">\n                                            <div class=\"comment ").concat(this.comment_color, "\">\n                                                <i class=\"fas fa-comment\"></i>\n                                                <span>").concat(this.comment, "</span>\n                                                \n                                            </div>\n                                        <div class=\"descr_image\">\n                                            <div class=\"image_text\">\n                                                <p>").concat(this.descr_header, "</p>\n                                                <p>").concat(this.descr_text, " <span class=\"red pointer\">here</span></p>\n                                            </div>\n                                            \n                                        </div>\n                                    </div>\n                                    <div class=\"body_product\">\n                                        <a href=\"\" class=\"no_a_decoration\">\n                                            <p class=\"title\">").concat(this.title, "</p></a>\n                                        <div class=\"block_stars\">\n                                            <div class=\"stars\">\n                                                <i class=\"fas fa-star\"></i>\n                                                <i class=\"fas fa-star\"></i>\n                                                <i class=\"fas fa-star\"></i>\n                                                <i class=\"fas fa-star\"></i>\n                                                <i class=\"fas fa-star\"></i>\n                                            </div>\n                                            <div class=\"reviews\">\n                                                <span>6 Review(s)</span>\n                                            </div>\n                                        </div>\n                                        <div class=\"price\">\n                                                <span class=\"currency\">$</span>\n                                                <span class=\"n_price\">").concat(this.n_price, "</span>\n                                                <del class=\"oldprice\">$ ").concat(this.oldprice, "</del>\n                                        </div>\n                                        <div class=\"buttons disp_none\">\n                                            <ul class=\"ul_li\">\n                                                <li>\n                                                    <a href=\"\" class=\"add_to_card\">\n                                                        <span class=\"gray-round\">\n                                                            <i class=\"fas fa-shopping-bag\"></i>\n                                                        </span>\n                                                    </a>\n                                                    \n                                                </li>\n                                                <li>\n                                                    <span class=\"gray-round\">\n                                                        <i class=\"fas fa-balance-scale\"></i>\n                                                    </span>\n                                                </li>\n                                                <li>\n                                                    <span class=\"gray-round\">\n                                                        <i class=\"fas fa-heart\"></i>\n                                                    </span>\n                                                </li>\n                                            </ul>\n                                        </div>\n                                    </div>\n                                </div>");
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            throw new Error("Error from fetch ".concat(url, " status: ").concat(result.status));
          case 5:
            _context.next = 7;
            return result.json();
          case 7:
  ...
  getProduct("http://localhost:3000/products").then(function (data) {
    data.forEach(function (_ref2) {
      var comment = _ref2.comment,
        comment_color = _ref2.comment_color,
        img = _ref2.img,
        title = _ref2.title,
        top_title = _ref2.top_title,
        product_text = _ref2.product_text,
        new_price = _ref2.new_price,
        old_price = _ref2.old_price;
      new cardProduct(comment, comment_color, img, title, top_title, product_text, new_price, old_price, ".product_list").render();
    });
  });
}
;
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (getProductsToCart);

/***/ }),

/***/ "./script/module/search_dropdown.js":
/*!******************************************!*\
  !*** ./script/module/search_dropdown.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var search_dropdown = function search_dropdown() {
  ...
  search.addEventListener("input", function (e) {
    ...
    fetch('../../php/search.php', {
      ...
      for (var i = 0; i < json.length; i++) {
        create_ul.innerHTML += "<li class=\"search_li\">                                                    <a href=\"".concat(json[i].href, "\">").concat(json[i].text, "</a>                                                    </li>");
      }
      search_drop_down.innerHTML = create_ul.outerHTML;
    })["catch"](console.log("Error"));
  });
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (search_dropdown);
...
(function () {
  var search_dropdown = (__webpack_require__(/*! ./module/search_dropdown.js */ "./script/module/search_dropdown.js")["default"]);
  var get_product_to_cart = (__webpack_require__(/*! ./module/get_product_to_cart.js */ "./script/module/get_product_to_cart.js")["default"]);
  var add_to_card = (__webpack_require__(/*! ./module/add_to_card.js */ "./script/module/add_to_card.js")["default"]);
  var delete_items_from_cart = (__webpack_require__(/*! ./module/delete_from_cart.js */ "./script/module/delete_from_cart.js")["default"]);
  var count_items_in_cart = (__webpack_require__(/*! ./module/count_items_in_cart.js */ "./script/module/count_items_in_cart.js")["default"]);
  var calculate_cart = (__webpack_require__(/*! ./module/calculate_cart.js */ "./script/module/calculate_cart.js")["default"]);
  get_product_to_cart();
  search_dropdown();
